<template>
    <div class="scels--item " :class="classSet" @mouseover="setHoverOnBtn()" @mouseleave="setUnhoverOnBtn()">
        <div>
        ...
        <NuxtLink :to="url" class="flex gap-4 items-center">
            <span class="scels--item--link font-medium text-[#fff] uppercase text-[1.2rem] sm:text-3xl">Читать</span>
            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path :d="arrowPositionValue" stroke="#fff" stroke-width="2" />
                <path d="M13.332 5.22241L18.332 10.2224L13.332 15.2224" stroke="#fff" stroke-width="2" />
            </svg>
        </NuxtLink>
    </div>
</template>
